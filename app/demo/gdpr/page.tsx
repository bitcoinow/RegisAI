...
import { UK_DEMO_V1, UK_DEMO_V2 } from '@/lib/demo-data'
import { buildCoverageMatrix, computeDelta } from '@/lib/coverage'

export const dynamic = 'force-dynamic'

const coverageV1 = buildCoverageMatrix('UK', undefined, UK_DEMO_V1.findings)
const coverageV2 = buildCoverageMatrix('UK', undefined, UK_DEMO_V2.findings)

const delta = computeDelta(UK_DEMO_V1.findings, UK_DEMO_V2.findings)
const comparison: ComparisonData = {
  scanNumber: 2,
  previousDate: UK_DEMO_V1.created_at,
  previousScore: UK_DEMO_V1.compliance_score ?? null,
  currentScore: UK_DEMO_V2.compliance_score ?? null,
  previous: {
    high: UK_DEMO_V1.high_risk,
    medium: UK_DEMO_V1.medium_risk,
    low: UK_DEMO_V1.low_risk,
    total: UK_DEMO_V1.total_gaps,
  },
  current: {
    high: UK_DEMO_V2.high_risk,
    medium: UK_DEMO_V2.medium_risk,
    low: UK_DEMO_V2.low_risk,
    total: UK_DEMO_V2.total_gaps,
  },
